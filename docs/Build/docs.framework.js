...
var ASM_CONSTS = {
  5421040: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5421101: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5421165: function() {return Module.webglContextAttributes.powerPreference;},  
 5421223: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5421278: function($0) {performance.now = function() { return $0; };},  
 5421326: function($0) {performance.now = function() { return $0; };},  
 5421374: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _disconnectPlayer(playerDTO) {
  ...
  function _moves(playerDTO) {
  		socket.emit('moves', UTF8ToString(playerDTO));
  	}

  function _resetGameIO() {
  		socket.emit('resetGame');
  	}

  function _rotates(playerDTO) {
  ...
  function _throwGrenade(playerDTO) {
